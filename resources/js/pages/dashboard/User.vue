            ...
            <b-row>
                ...
                <b-col lg="6" md="6" sm="6">
                    <div class="d-flex">
                        <div class="col"></div>
                        <div>
                            <b-button variant="primary" @click="requestPayment()">Request Test Paymeny</b-button>
                        </div>
                    </div>
                </b-col>
            </b-row>
...
export default {
    ...
    methods:{
        ...
        async requestPayment(){
            try{
                var req = await axios.post('/api/payment/request')
                if(req.status == 200){
                    als.fire({title: 'Pyment created successfully.',});
                    this.loadData();
                }
